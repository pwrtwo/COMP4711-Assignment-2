...
class Sets extends CSV_Model {
    ...
    public function rules() {
        $config = array(
                ['field' => 'helmId', 'label' => 'helm', 'rules' => 'integer'],
                ['field' => 'chestId', 'label' => 'chest', 'rules' => 'integer'],
                ['field' => 'primaryId', 'label' => 'primary', 'rules' => 'integer'],
                ['field' => 'secondaryId', 'label' => 'secondary', 'rules' => 'integer'],
        );
        return $config;
    }
}